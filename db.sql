...
CREATE DATABASE IF NOT EXISTS `isbalanced` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `isbalanced`;
...
INSERT IGNORE INTO `atc` (`atcCode`, `atcDescription`, `locale`) VALUES
...
INSERT IGNORE INTO `drug` (`drugId`, `atcCode`) VALUES
	(1, 'C09X'),
	(2, 'C10A'),
	(3, 'C10A'),
	(4, 'C01B'),
...
INSERT IGNORE INTO `druglanguage` (`drugId`, `alternativeProposalPrescribe`, `benefitsAvoid`, `indication`, `locale`, `name`, `reasonWhyToAvoid`) VALUES
...
INSERT IGNORE INTO `sanitaryalert` (`drug`, `id`, `link`) VALUES
...
-- Volcando datos para la tabla isbalanced.user: ~0 rows (aproximadamente)
INSERT IGNORE INTO `user` (`login`, `password`) VALUES
